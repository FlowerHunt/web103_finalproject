...
[We had a clearer idea of what we could realistially achieve and what we really couldn't within the current scope. This made it easier to approach the development of the project.]

### 2. What were some challenges your group faced in this unit?

[Difficulty finding appropriate APIs for our project's needs. We had to swap APIs multiple times, eventually settling on one that seems to work fine for what our project needs. Ideally, this would have been properly resolved earlier in project development so we could focus more attention to other aspects of the project.]

### 3. What were some of the highlights or achievements that you are most proud of in this project?

[Something I'm proud of in this project is how simple and intuitive the site is to use. It has a very simple, relaxed design, with an interface and layout that is very easy to understand and get accustomed to. This increases usability and reduces resistance for new users to learn how to use the app.]

### 4. Reflecting on your web development journey so far, how have you grown since the beginning of the course?

[I've gotten much better at working with a group on the same repository. Having to create new branches, do pull requests, review others' pull requests, and merge, provides a different perspective to a project's life cycle than you get working alone. So I've become a more competent collaborative developer over this course.]

### 5. Looking ahead, what are your goals related to web development, and what steps do you plan to take to achieve them?

[My goal is to become a full-time web developer or software engineer. I plan to continue building projects, learning, and developing my ability to cooperate with others in development.]
